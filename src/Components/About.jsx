        ...
        <div className='container mx-auto flex px-10 py-20 md:flex-row flex-col items-center h-screen transparent'>
            <div className='lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center'>
                ...
                <motion.p initial={{x: -500}} animate={{x: 0}} transition={{ delay: 0.5 }}
                    ...
                    className="mb-8 leading-relaxed text-3xl flex flex-row text-white"
                > 
                ...
                <div className="flex justify-center">
                    ...
                    <Link to='projects' spy={true} smooth={true}>
                        ...
                        whileHover={{scale: 1.1}}
                        transition={{type: "spring", stiffness: 100, damping: 5}}
                        className="ml-4 inline-flex text-white cursor-pointer bg-black border-2 hover:border-none hover:bg-cyan-400 hover:text-black py-2 px-6 focus:outline-none rounded-[40px] hover:shadow-cyan-400 hover:shadow-2xl text-lg">
                        See My Past Work
                        </motion.a>
